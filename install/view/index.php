                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" value=""  id="purchase_code"  name="purchase_code" class="form-control"  value="NullJungle.com" placeholder="Find in codecanyon item download section" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
