                    ...
                    <div class = "card  p15 no-border clearfix inline-block w100p mb0">
                        ...
                        <div class="mr15 strong float-start">
                            ...
                            if (get_setting("add_signature_option_on_accepting_estimate")) {
                                echo modal_anchor(get_uri("estimates/accept_estimate_modal_form/$estimate_info->id"), "<i data-feather='check-circle' class='icon-16'></i> " . app_lang('mark_as_accepted'), array("class" => "btn btn-success mr15", "title" => app_lang('accept_estimate')));
                            } else {
